...
ARG CUDA_ARCHITECTURES="7.5;8.6"
...
# clone all files from repo to /workspace since host volume is mapped instead of original folder
RUN if [ ! -d /workspace ]; then mkdir -p /workspace; fi
